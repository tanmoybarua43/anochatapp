            ...
            <div className="container">
                <div className="signup-content">
                    <div className="signup-form">
                        ...
                        <form method="POST" className="register-form" id="register-form" onSubmit={SignUpUser} >
                            <div className="form-group">
                                <label htmlFor="name"><i className="zmdi zmdi-account material-icons-name"></i></label>
                                <input type="text" name="fname" id="fname" placeholder="Your Full Name" onChange={(e)=>{setfName(e.target.value)}} value={fName}/>
                            </div>
                            <div className="form-group">
